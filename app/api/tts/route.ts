    ...
    try {
        ...
        const request: SynthesizeSpeechRequest = {
            ...
            audioConfig: {
                ...
                speakingRate: 0.9,     // Slightly slower than normal for clearer pronunciation
                pitch: -1.0,           // Slightly lower pitch for natural male voice
                volumeGainDb: 1.0,     // Slightly increased volume
